...
**定位**：离线训练与导出。**本仓不训练模型**（见 `../docs/reports/model_dropin_and_feedback.md`）：
...
`maxConfDelta = 0.001302`。详见 `../docs/reports/t07_t08_pipeline.md`。
...
* 现有 `P01`–`P05` 是**合成**语料，已在
  `../docs/compliance/C-02/synthetic_corpus_notice.md` 显式声明；真实招募开始前必须先删除或重编号。
