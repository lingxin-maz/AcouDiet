...
| `AcouDiet/app/assets/models/` | `acoudiet_fp32_v1.1.0.tflite` | 4,051,716 | `705ffc62…560a` |
...
| `AcouDiet/ai/artifacts/` | `acoudiet_int8_PIPELINECHECK.tflite`（本仓管线自检产物，非交付件） | 1,096,936 | `a285e480…c9c26` |
