...
/// The SSOT lives at the repository root; this tool lives at <root>/AcouDiet/tool.
/// Candidates are tried in order so the generator works both from the repository
/// (AcouDiet/ inside the repo) and from a standalone copy of AcouDiet/.
