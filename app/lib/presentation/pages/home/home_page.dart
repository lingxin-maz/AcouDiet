                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // The start-detection button used to live here (the mockups' circular
                        // microphone badge + mint stadium button). It was REMOVED on the user's
                        // instruction: the shell's 「检测」 tab is the single entry to the
                        // detection page, and having two ways to start a capture on the same
                        // screen invited the user to start one from a page that cannot show it.
                        //
                        // NOTE the detection page's own primary button is untouched -- it still
                        // reads 「开始 AI 检测」 (`UiStrings.startDetect`, used by
                        // `detect_presenter.dart`). Only this second, duplicate entry is gone.
